...
const NFTCollection = () => {
  ...
  <div class="container max-w-lg bg-white rounded dark:bg-gray-800 shadow-lg transform duration-200 easy-in-out m-12">
    ...
    <div class="">
      <div class="px-7 mb-8">
        <h2 class="text-3xl font-bold text-indigo-800 dark:text-gray-300">Beth J. indigoe</h2>
        ...
        <div
          class="justify-center px-4 py-2 cursor-pointer bg-indigo-900 max-w-min mx-auto mt-8 rounded-lg text-gray-300 hover:bg-indigo-800 hover:text-gray-100 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-gray-200">
          bethindigoe@gmail.com
        </div>
        <div class="flex flex-wrap justify-center gap-2 sm:gap-4 mt-8">
          <button
            class="text-indigo-900 hover:text-indigo-700 p-1 sm:p-2 inline-flex items-center dark:text-gray-400 dark:hover:text-gray-300">
          ...
          <button
            class="text-indigo-900 hover:text-indigo-700 p-1 sm:p-2  inline-flex items-center dark:text-gray-400 dark:hover:text-gray-30 dark:text-gray-400 dark:hover:text-gray-300">
            <svg class="w-7 h-7 fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path
