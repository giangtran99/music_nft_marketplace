        ...
        <div
          ...
          <div className="">
            <div className="px-7 mb-8">
              <a href='/creator/1' className="text-3xl font-bold text-indigo-800 dark:text-gray-300">Giang Tran</a>
              ...
              <div className="flex flex-wrap justify-center gap-2 sm:gap-4 mt-8">
                <button
                  className="text-indigo-900 hover:text-indigo-700 p-1 sm:p-2 inline-flex items-center dark:text-gray-400 dark:hover:text-gray-300">
                ...
                <button
                  className="text-indigo-900 hover:text-indigo-700 p-1 sm:p-2  inline-flex items-center dark:text-gray-400 dark:hover:text-gray-30 dark:text-gray-400 dark:hover:text-gray-300">
                  <svg className="w-7 h-7 fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path
