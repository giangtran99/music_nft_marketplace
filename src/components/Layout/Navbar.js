              ...
              <div className="flex items-center justify-between h-16">
                ...
                <div className="hidden md:block">
                  <div className="ml-4 flex items-center md:ml-6">
                    ...
                    <button onClick={connectWalletHandler} className="mr-4 text-center p-auto text-center w-[120px] bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold px-3 py-2 rounded inline-flex items-center">
